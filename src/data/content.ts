...
export const CLIENT_LOGOS: ClientLogo[] = [
  { name: 'Renolit', src: `${CDN}/virtualpools-client-logo-gradient-renolit-oMFM1.webp` },
  { name: 'Haogenplast', src: `${CDN}/virtualpools-client-logo-gradient-haogenplast-EvagS.webp` },
  { name: 'Compass Pools', src: `${CDN}/virtualpools-client-logo-gradient-compass-pools--y5_j.webp` },
  { name: 'TA', src: `${CDN}/virtualpools-client-logo-gradient-ta-YRLHn.webp` },
  { name: 'Fluvo', src: `${CDN}/virtualpools-client-logo-gradient-fluvo-gHzVz.webp` },
  { name: 'LPW Pools', src: `${CDN}/virtualpools-client-logo-gradient-lpw-pools-_ElpW.webp` },
  { name: 'Duratech', src: `${CDN}/virtualpools-client-logo-gradient-duratech-QRx8t.webp` },
  { name: 'Scandiroc', src: `${CDN}/virtualpools-client-logo-gradient-scandiroc-Nbg_j.webp` },
  { name: 'Bluedrops', src: `${CDN}/virtualpools-client-logo-gradient-bluedrops-y4Jen.webp` },
  { name: 'Binder24', src: `${CDN}/virtualpools-client-logo-gradient-binder24-hRgTe.webp` },
]
...
export const TEXT_TESTIMONIALS: TextTestimonial[] = [
  {
    ...
    logoSrc: `${CDN}/logo-piscine-services-KaZsc.png`,
  },
  {
    quote:
    ...
    company: 'ACZwembaden',
    logoSrc: `${CDN}/logo-aczwembaden-aAUmz.png`,
  },
  {
    quote:
...
export const CTA_BAND = {
  ...
  body:
    'Talk to us about your business. After the demo, we will tailor VirtualPools to your sales process, giving you a custom pool configurator designed to help you generate leads, improve client presentations, and close deals faster.',
