...
export default function DemoExperience({ step, onStepChange }: { step: 1 | 2 | 3; onStepChange: (step: 1 | 2 | 3) => void }) {
  ...
  const card = (
    <div className="rounded-[10px] bg-white p-6 sm:p-8" style={{ boxShadow: '0 20px 60px 0 rgba(7, 0, 47, 0.2)' }}>
      {step === 1 && (
